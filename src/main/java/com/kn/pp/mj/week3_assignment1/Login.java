...
public class Login extends HttpServlet {
	 ...
	 * This is constructor for the login class.
	 */
	public Login() {
		super();
	}
	 ...
	 *      response)
	 *      This function is executed when the post request is sent from the index page for submitting username and password.
	 *      This function adds first validates the password and then stores the username to a Session, Cookie and 
	 *      sends data via RequestDispatcher to another Servlet called QuickServlet if the validation of password holds true.
	 *      
	 */
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (passW.equals("rishi")) {
			...
			RequestDispatcher rd = request.getRequestDispatcher("QuickServlet"); // create a request dispatcher object to another servlet
